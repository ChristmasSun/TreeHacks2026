...
class NormalEquationScene(Scene):
    def construct(self):
        ...
        self.wait(1.2)  # ~0.0 - 3.2 (3.2s total)
        ...
        self.wait(2.3)  # segment total: 0.7+1.4+2.3=4.4
        ...
        self.wait(0.2)
        self.wait(3.4)  # segment total: 0.6+0.6+0.2+3.4=4.8
        ...
        eq_leftover = MathTex(r"X^{T}X\,\theta - X^{T}y", font_size=72).set_color(WHITE)
        self.play(Write(eq_leftover), run_time=1.6)
        self.wait(1.9)  # segment total: 0.6+1.6+1.9=4.1
        ...
        self.wait(1.2)  # segment total: 0.6+0.6+0.6+1.2=3.0
        ...
        self.wait(1.2)  # segment total: 0.6+1.2+1.2=3.0
        ...
        self.wait(0.1)  # must be > 0; previously 0.0 caused failure (segment total: 2.1)
        ...
        self.play(ReplacementTransform(caption, new_caption), run_time=0.6)
        caption = new_caption
        self.wait(2.2)  # segment total: 2.8
        ...
        self.wait(0.4)  # segment total: 2.2
        ...
        self.play(ReplacementTransform(caption, new_caption), run_time=0.6)
        caption = new_caption
        self.wait(1.7)  # segment total: 2.3
        ...
        self.wait(1.6)  # segment total: 3.6
        ...
        self.wait(1.1)  # segment total: 2.7
        ...
        self.wait(0.8)  # segment total: 2.4 (overall ~45.2s)